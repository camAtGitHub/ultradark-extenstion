...
1.  **Variable Indexing (The "Root" Canal):**
    ...
    - Modify the _variables_ directly rather than individual elements where possible. This utilizes the browser's native cascading engine for performance.

2.  **Semantic Classification:**
    - Don't just look at colors; look at _roles_.
