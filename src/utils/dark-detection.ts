...
export function isAlreadyDarkTheme(): boolean {
  ...
  if (document.getElementById('udr-style') || 
      document.getElementById('udr-preinject') || 
      document.getElementById('udr-shield') ||
      html.getAttribute('udr-applied') === 'true' ||
      html.getAttribute('data-udr-applied') === '1') {
