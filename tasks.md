...
- When a user selects a theming algorithm (e.g., "Chroma-Semantic") from the popup dropdown, all sliders and controls related to _other_ algorithms must receive the `disabled` attribute and appear grayed out.
